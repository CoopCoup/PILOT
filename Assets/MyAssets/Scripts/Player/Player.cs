...
public class Player : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        var weaponInput = new WeaponManagerInput
        {
            ...
            PlayerCamera = actualCamera,

            ActionDown = input.Action.IsPressed(),
            ActionPressed = input.Action.WasPressedThisFrame(),
            ReadyDown = input.Ready.IsPressed(),
        ...
        // Apply any camera shake if a weapon is causing it
        if (_weaponEffects.CameraShakeRequested)
        {
            cameraShake.AddShake(_weaponEffects.WeaponCamShake);
        }

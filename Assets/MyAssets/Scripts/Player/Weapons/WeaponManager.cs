...
public class WeaponManager : MonoBehaviour
{
    ...
    [SerializeField] private GameObject flareGunPrefab;
    ...
    public void Initialise()
    {
        ...
        if (startWithFlareGun)
        {
            PickupWeapon(WeaponID.FlareGun);
        }
    }
    ...
    public void PickupWeapon(WeaponID newWeaponID)
    {
        ...
        switch (newWeaponID)
        {
            ...
            case WeaponID.FlareGun:
                ...
                {
                    GameObject flareGunWeapon = Instantiate(flareGunPrefab, this.transform.position, Quaternion.identity);
                    flareGunWeapon.transform.SetParent(weaponSocket.transform, false);
                    _inventory.Add(WeaponID.FlareGun, flareGunWeapon.GetComponent<FlareGunWeapon>());
                    _requestedWeapon = WeaponID.FlareGun;
                }
                break;
        }
    }
    ...
    private void ProcessInput(WeaponManagerInput input)
    {
        ...
        _requestedActionHeld = input.ActionDown;
